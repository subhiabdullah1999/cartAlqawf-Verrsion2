...
class AppThemeData {
  ...
  static final stepTextStyle_12 =
      TextStyle(fontFamily: "Poppins Medium", fontSize: 12.sp);
  static final headerTextStyle_16reg =
      TextStyle(fontFamily: "Poppins Medium", fontSize: 16.sp);
  ...
  static final todayDealNewStyleTab = TextStyle(
      ...
      fontFamily: "Poppins Medium",
      fontSize: 8.sp);
  static final todayDealTitleStyle = TextStyle(
      color: Colors.black, fontFamily: "Poppins Medium", fontSize: 12.sp);
  static final todayDealTitleStyleTab = TextStyle(
      color: Colors.black, fontFamily: "Poppins Medium", fontSize: 10.sp);
